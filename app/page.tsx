  ...
  return (
    <div className="w-full flex flex-1 flex-col gap-y-20 items-center animate__animated animate__backInUp" >
      <div className="relative">
        ...
        <Image height={54.58} width={41} className="max-[768px]:hidden" src={Vector} alt="Logo"/>
         <h1 className="text-[28px] min-[768px]:hidden font-bold tracking-tighter bg-clip-text bg-gradient-to-r from-black to-purp text-transparent">Negotio</h1>
      </div>
